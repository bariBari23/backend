package store.baribari.demo.common.repository
...
class RedisRepository(
    ...
    fun getRefreshTokenByEmail(email: String): String? = redisTemplate.opsForValue().get(email)

    fun setRefreshTokenByEmail(
        email: String,
        refreshToken: String,
    ) {
        redisTemplate
    ...
    fun getEmailByCode(code: String): String? = redisTemplate.opsForValue().get(code)
