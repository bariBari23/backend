...
class MyDataInit(
    ...
    private fun userCreate(): List<User> {
        ...
        val customer = User(
            email = "customer@test.com", password = "customer", role = Role.ROLE_CUSTOMER, userCart = Cart(), phoneNumber = "010-1234-5678",username = "testuser",
            position = Position(
                latitude = 37.4927015,
        ...
        val storeOwner = User(
            email = "store@test.com", password = "store", role = Role.ROLE_STORE, userCart = Cart(), phoneNumber = "010-1234-5678", username = "testuser2",
        )
